  ...
  ++  parse-response
    ...
    ::
      ...
      :~  =-  ['tx' (un (ot -))]
          ...
          ['unknown' (un (om so))]
          =-  ['inputs' (un (ar (ou -)))]
          :~  ['non_witness_utxo' utxo-parser]
            ::
              ['witness_utxo' utxo-parser]
            ::
            ...
            ::
              ...
              (cu sig-hash so)
            ::
              ['redeem_script' script-parser]
            ::
              ['witness_script' script-parser]
            ::
              =-  ['bip32_derivs' (uf ~ (mu -))]
              =-  (op hex (ot -))
